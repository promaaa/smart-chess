...
class OpeningBook:
    ...
    def __init__(self, book_path: Optional[str] = None, book_type: str = "auto"):
        ...
        """
        self.book_path = book_path or "data/openings.json"
...
def create_basic_book(filepath: str = "data/openings.json"):
    """
...
if __name__ == "__main__":
    ...
    book_poly = OpeningBook("../book/Cerebellum_Light.bin", book_type="polyglot")
